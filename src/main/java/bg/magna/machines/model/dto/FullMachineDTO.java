...
public class FullMachineDTO {
    ...
    public FullMachineDTO(String id, String name, String imageURL, int year, String brandName, String descriptionEn, String descriptionBg, double workingWidth, int weight, int requiredPower, String moreInfoEn, String moreInfoBg) {
        this.id = id;
        this.name = name;
